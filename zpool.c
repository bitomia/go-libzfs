...
nvlist_ptr go_zpool_search_import(libzfs_handle_ptr zfsh, int paths, char **path, boolean_t do_scan) {
    ...
    libpc_handle_t pc_handle = {0};
    pc_handle.lpc_lib_handle = &zfsh;
    pc_handle.lpc_ops = &libzfs_config_ops;
    pc_handle.lpc_printerr = B_TRUE;
    pools = zpool_search_import(&pc_handle, &idata);
